import time
from celery_tasks.tasks import andrea_summarize_predict, codegen_generate, codet5_predict, shinkaiGAN_generate
...
#INPUT_TEXT = "please write a python program for the sum of two sequence of items"
...
taskid = andrea_summarize_predict.delay(INPUT_TEXT)
